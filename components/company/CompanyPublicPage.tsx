...
import { MapPin, Globe, Instagram, Linkedin, Building2, ArrowLeft, MessageCircle, FileText, ImageOff, Quote, Star, TrendingUp, Users, Share } from 'lucide-react';
                ...
                <div className="relative z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center animate-fade-in-up">
                    ...
                    <div className="mt-12 flex flex-wrap justify-center gap-4">
                        ...
                        <button
                            ...
                            className="px-8 py-3 rounded-xl font-bold bg-white/5 border border-white/10 text-white flex items-center gap-2 hover:bg-white/10 transition-colors"
                        >
