      ...
      <div className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-16 animate-fade-in-up">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10 mb-6">
             ...
             <span className="text-xs font-medium text-slate-300 uppercase tracking-widest">Networking & Conhecimento</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white tracking-tight">Agenda do Ecossistema</h1>
        ...
        {loading ? (
            ...
            {events.length === 0 ? (
                <div className="text-center py-20 bg-white/5 rounded-3xl border border-white/10">
                    ...
                    <p className="text-lg text-slate-400">Nenhum evento futuro agendado no momento.</p>
                </div>
            ) : (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                    {events.map((evt) => {
                        ...
                        return (
                            <div key={evt.id} className="group bg-white/5 border border-white/10 rounded-3xl overflow-hidden hover:border-brand-neon/50 transition-all duration-300 flex flex-col">
                                <div className="h-48 bg-slate-900 relative overflow-hidden">
                                    {evt.imagem_capa ? (
                                        ...
                                        <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-brand-green/20 to-blue-900/20">
                                    ...
                                    <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black to-transparent">
                                         <div className="flex items-center gap-2 text-white font-mono font-bold">
                                             ...
                                             <div className="flex flex-col">
                                                 ...
                                                 <span className="text-xs text-slate-400">{evt.local}</span>
                                             </div>
                                         </div>
                                    </div>
                                </div>
                                ...
                                <div className="p-6 flex-1 flex flex-col">
                                    <h3 className="text-xl font-bold text-white mb-2 line-clamp-2">{evt.titulo}</h3>
                                    <p className="text-slate-400 text-sm line-clamp-3 mb-6 font-light">{evt.descricao}</p>
                                    ...
                                    <div className="mt-auto pt-4 border-t border-white/5 flex justify-between items-center">
                                        ...
                                        <button 
                                            ...
                                            className="px-4 py-2 bg-brand-green text-black rounded-xl text-sm font-bold hover:bg-white transition-colors flex items-center gap-2 disabled:opacity-50"
                                        >
